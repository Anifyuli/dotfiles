return {
  ...
  keys = {
    ...
    { "<c-/>",      function() Snacks.terminal.toggle({ "tmux", "new-session", "-A", "-s", "nvimterm" }) end, desc = "Toggle  Terminal" },
    { "<c-_>",      function() Snacks.terminal.toggle({ "tmux", "new-session", "-A", "-s", "nvimterm" }) end, desc = "which_key_ignore" },
  },
}
